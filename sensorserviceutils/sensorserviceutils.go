...
func Parse(f string, meta *bugreportutils.MetaInfo) ([]*acpb.ActiveConn, []error) {
	...
	if err != nil {
		return nil, []error{fmt.Errorf("could not find dumpstate information in the bugreport: %v", err)}
	}
	...
	return p.createActiveConnPB(), p.errs
}
