	...
	tests := []struct {
	...
	}{
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`BMI160 Step counter,string,1436292420000,1436292420000,"18:07:00,18:07:00,24,on-change,10013,com.google.android.gms.fitness.sensors.d.b,250000,0,Sensorservice Dump,isActiveConn",`,
				`BMP280 pressure,string,1436292420000,1436292420000,"18:07:00,18:07:00,4,continuous,10013,com.google.android.location.collectionlib.w,66670,0,Sensorservice Dump,isActiveConn",`,
				`RPR0521 light,string,1436292420000,1436292420000,"18:07:00,18:07:00,7,on-change,1000,com.android.server.display.AutomaticBrightnessController,200000,100000,Sensorservice Dump,isActiveConn",`,
				`Window Orientation,string,1436292420000,1436292420000,"18:07:00,18:07:00,31,on-change,1000,com.android.server.policy.WindowOrientationListener,20000,0,Sensorservice Dump,isActiveConn",`,
				`BMI160 accelerometer,string,1436292420000,1436292420000,"18:07:00,18:07:00,1,continuous,10182,civ,20000,0,Sensorservice Dump,isActiveConn",`,
			}, "\n"),
		},
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`BMI160 Step counter,string,1436292420000,1436292420000,"18:07:00,18:07:00,24,on-change,10013,com.google.android.gms.fitness.sensors.d.b,250000,0,Sensorservice Dump,isActiveConn",`,
				`BMP280 pressure,string,1436292420000,1436292420000,"18:07:00,18:07:00,4,continuous,-1,,66670,0,Sensorservice Dump,isActiveConn",`,
			}, "\n"),
		},
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`BMI160 Step counter,string,1436292420000,1436292420000,"18:07:00,18:07:00,24,on-change,10013,com.google.android.gms.fitness.sensors.d.b,250000,0,Sensorservice Dump,isActiveConn",`,
				`Window Orientation,string,1436292420000,1436292420000,"18:07:00,18:07:00,31,on-change,1000,com.android.server.display.AutomaticBrightnessController,20000,0,Sensorservice Dump,isActiveConn",`,
			}, "\n"),
		},
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`BMI160 Step counter,string,1436292420000,1436292420000,"18:07:00,18:07:00,24,on-change,10013,com.google.android.gms.fitness.sensors.d.b,250000,0,Sensorservice Dump,isActiveConn",`,
				`BMP280 pressure,string,1436292420000,1436292420000,"18:07:00,18:07:00,4,continuous,10013,com.google.android.location.collectionlib.w,-1,-1,Sensorservice Dump,isActiveConn",`,
			}, "\n"),
			wantSensorErrors: []error{
		...
		},
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`BMI160 accelerometer,string,1436292001000,1436292420000,"18:00:01,18:07:00,1,continuous,10182,civ,2500,0,Sensorservice Dump,isActiveConn",`,
				`BMI160 Step counter,string,1436291941000,1436292420000,"17:59:01,18:07:00,24,on-change,10013,com.google.android.gms.fitness.sensors.d.b,2500,0,Sensorservice Dump,isActiveConn",`,
				`RPR0521 light,string,1436290801000,1436292420000,"17:40:01,18:07:00,7,on-change,1000,com.android.server.display.AutomaticBrightnessController,2500,0,Sensorservice Dump,isActiveConn",`,
				`BMP280 pressure,string,1436290211000,1436292420000,"17:30:11,18:07:00,4,continuous,10013,com.google.android.location.collectionlib.w,10000,0,Sensorservice Dump,isActiveConn",`,
				`Window Orientation,string,1436290211000,1436292420000,"17:30:11,18:07:00,31,on-change,1000,com.android.server.policy.WindowOrientationListener,20000,0,Sensorservice Dump,isActiveConn",`,
			}, "\n"),
		},
		{
			name: "[History] Test 2: " +
		...
		},
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`BMI160 Step counter,string,1436292001000,1436292420000,"18:00:01,18:07:00,24,on-change,10013,com.google.android.gms.fitness.sensors.d.b,2500,0,Sensorservice Dump,isActiveConn",`,
				`BMP280 pressure,string,1436291941000,1436292420000,"17:59:01,18:07:00,4,continuous,10013,com.google.android.location.collectionlib.w,66667,0,Sensorservice Dump,isActiveConn",`,
				`BMI160 accelerometer,string,1436291671000,1436292420000,"17:54:31,18:07:00,1,continuous,10182,civ,20000,0,Sensorservice Dump,isActiveConn",`,
				`RPR0521 light,string,1436291579000,1436291867000,"17:52:59,17:57:47,7,on-change,321,AA,12345,333,Sensorservice Dump",`,
				`RPR0521 light,string,1436291403000,1436292420000,"17:50:03,18:07:00,7,on-change,1000,com.android.server.display.AutomaticBrightnessController,200000,100000,Sensorservice Dump,isActiveConn",`,
				`Window Orientation,string,1436290921000,1436292420000,"17:42:01,18:07:00,31,on-change,1000,com.android.server.policy.WindowOrientationListener,20000,0,Sensorservice Dump,isActiveConn",`,
				`BMI160 Step counter,string,1436290861000,1436291193000,"17:41:01,17:46:33,24,on-change,135,CCC,155,155,Sensorservice Dump",`,
				`BMP280 pressure,string,1436290809000,1436291327000,"17:40:09,17:48:47,4,continuous,654,BB,66667,0,Sensorservice Dump",`,
			}, "\n"),
		},
		{
			name: "[History] Test 4: " +
