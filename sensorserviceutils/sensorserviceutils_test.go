...
func TestParse(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantActiveConn: map[int32]*acpb.ActiveConn{
				...
				3: {
					...
					SensorNumber:   7,
					PendingFlush:   0,
					SamplingPeriod: 200000,
					BatchingPeriod: 100000,
					HasRecord:      false,
				},
				4: {
					Number:         4,
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`Sensorservice Registration,string,1436292420000,1436292420000,"24,10013,com.google.android.gms.fitness.sensors.d.b,250000,0",`,
				`Sensorservice Registration,string,1436292420000,1436292420000,"4,10013,com.google.android.location.collectionlib.w,66670,0",`,
				`Sensorservice Registration,string,1436292420000,1436292420000,"7,1000,com.android.server.display.AutomaticBrightnessController,200000,100000",`,
				`Sensorservice Registration,string,1436292420000,1436292420000,"31,1000,com.android.server.policy.WindowOrientationListener,20000,0",`,
				`Sensorservice Registration,string,1436292420000,1436292420000,"1,10182,civ,20000,0",`,
			}, "\n"),
		},
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`Sensorservice Registration,string,1436292420000,1436292420000,"24,10013,com.google.android.gms.fitness.sensors.d.b,250000,0",`,
				`Sensorservice Registration,string,1436292420000,1436292420000,"4,-1,,66670,0",`,
			}, "\n"),
		},
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`Sensorservice Registration,string,1436292420000,1436292420000,"24,10013,com.google.android.gms.fitness.sensors.d.b,250000,0",`,
				`Sensorservice Registration,string,1436292420000,1436292420000,"31,1000,com.android.server.display.AutomaticBrightnessController,20000,0",`,
			}, "\n"),
		},
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`Sensorservice Registration,string,1436292420000,1436292420000,"24,10013,com.google.android.gms.fitness.sensors.d.b,250000,0",`,
				`Sensorservice Registration,string,1436292420000,1436292420000,"4,10013,com.google.android.location.collectionlib.w,-1,-1",`,
			}, "\n"),
			wantSensorErrors: []error{
		...
		},
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`Sensorservice Registration,string,1436292001000,1436292420000,"1,10182,civ,2500,0",`,
				`Sensorservice Registration,string,1436291941000,1436292420000,"24,10013,com.google.android.gms.fitness.sensors.d.b,2500,0",`,
				`Sensorservice Registration,string,1436290801000,1436292420000,"7,1000,com.android.server.display.AutomaticBrightnessController,2500,0",`,
				`Sensorservice Registration,string,1436290211000,1436292420000,"4,10013,com.google.android.location.collectionlib.w,10000,0",`,
				`Sensorservice Registration,string,1436290211000,1436292420000,"31,1000,com.android.server.policy.WindowOrientationListener,20000,0",`,
			}, "\n"),
		},
		{
			name: "[History] Test 2",
		...
		},
		{
			...
			wantCSV: strings.Join([]string{
				csv.FileHeader,
				`Sensorservice Registration,string,1436292001000,1436292420000,"24,10013,com.google.android.gms.fitness.sensors.d.b,2500,0",`,
				`Sensorservice Registration,string,1436291941000,1436292420000,"4,10013,com.google.android.location.collectionlib.w,66667,0",`,
				`Sensorservice Registration,string,1436291671000,1436292420000,"1,10182,civ,20000,0",`,
				`Sensorservice Registration,string,1436291579000,1436291867000,"7,321,AA,12345,333",`,
				`Sensorservice Registration,string,1436291403000,1436292420000,"7,1000,com.android.server.display.AutomaticBrightnessController,200000,100000",`,
				`Sensorservice Registration,string,1436290921000,1436292420000,"31,1000,com.android.server.policy.WindowOrientationListener,20000,0",`,
				`Sensorservice Registration,string,1436290861000,1436291193000,"24,135,CCC,155,155",`,
				`Sensorservice Registration,string,1436290809000,1436291327000,"4,654,BB,66667,0",`,
			}, "\n"),
		},
		{
			name: "[History] Test 4",
