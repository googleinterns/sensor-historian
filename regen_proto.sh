...
protoc -I=github.com/googleinterns/sensor-historian/pb/activeconnection_proto/ --go_out=. github.com/googleinterns/sensor-historian/pb/activeconnection_proto/*.proto
